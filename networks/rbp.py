...
class RBP(Recurrent):
    '''RBP architecture - Hosseini & Maida, 2020.
    ...
    # Arguments
        ...
        output_mode: either 'error', 'prediction', 'all' or layer specification (ex. R2, see below).
            Controls what is outputted by the RBP.
    ...
    def __init__(self, stack_sizes, R_stack_sizes,
        ...
        super(RBP, self).__init__(**kwargs)
        ...
        for c in sorted(self.conv_layers.keys()):
            for l in range(len(self.conv_layers[c])):
                ...
                if c == 'ahat':
                    ...
                    if l < self.nb_layers - 1:
                        nb_channels += self.stack_sizes[l+1] * 2
    ...
    def step(self, a, states):
        ...
        for l in reversed(range(self.nb_layers)):
            ...
            if l < self.nb_layers - 1:
                e_up = self.upsample.call(e_tm1[l+1])
                inputs.append(e_up)
        ...
        for l in range(self.nb_layers):
            ...
            if l < self.nb_layers - 1:
                a = self.conv_layers['a'][l].call(r[l])
    ...
    def get_config(self):
        ...
        base_config = super(RBP, self).get_config()
